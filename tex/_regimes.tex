...
The expression $f$ contains three terms which are of zeroth, first, and second order $λ / r$.
...
On further increasing the field ($\sqrt{ω τ} ≫ λ / r ≫ 1$) we get
\begin{equation}
  \label{eq:regime.2.f}
  f = \frac{1}{2 \sqrt{ω τ}}
      e^{- \left( L / λ \right) \sqrt{ω τ / 2}}
...
the lifetimes as estimated with infinite contact resistance are long
enough that the approximation of $\sqrt{ω τ} ≫ λ / r ≫ 1$
is still valid for much of the data being analyzed.
For this case the infinite contact resistance yields a normalized $\rNL$ of the form
\begin{equation}
...
assuming infinite contact resistance as a function decreasing $r$,
