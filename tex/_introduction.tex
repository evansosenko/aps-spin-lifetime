...
Unfortunately, the best measured spin life times
...
% In section I we provide the basic model, define the relevant parameters,
% write down the Bloch equations and the appropriate boundary conditions.
% In section II the solution to the equation is derived and fitted to data.
% In section III we analyze the various regimes which are determined by the diffusion length,
% length of the device and the contact resistance.
% Section IV ends with a summary of the results and future directions.
